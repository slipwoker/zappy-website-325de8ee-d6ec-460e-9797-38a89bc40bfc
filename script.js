  ...
  if (form) {
    ...
    form.addEventListener('submit', (e) => {
      ...
      if (isValid) {
        ...
        successMsg.style.cssText = 'color:#16a34a;font-size:1rem;margin-top:1rem;text-align:center;';
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '325de8ee-d6ec-460e-9797-38a89bc40bfc',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '325de8ee-d6ec-460e-9797-38a89bc40bfc';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '325de8ee-d6ec-460e-9797-38a89bc40bfc';
